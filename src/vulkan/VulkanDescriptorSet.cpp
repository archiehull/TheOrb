...
void VulkanDescriptorSet::CreateDescriptorSets(const std::vector<VkBuffer>& uniformBuffers, VkDeviceSize bufferSize, VkImageView textureImageView, VkSampler textureSampler) {
